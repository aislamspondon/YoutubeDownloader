...
window.title("YOUTUBE VIDEO DOWNLOADER BY SPONDON")

youtube_logo = PhotoImage(file="youtube.png")
window.iconphoto(False, youtube_logo)
Label(window, text="Youtube Video Downloader", font=("Arial",30,"bold"),bg="lightgreen").pack(padx=5, pady=50)
...
def video_download():
    ...
    Label(window,text="Check out your project Folder",font=("Arial",15,"bold"),bg="yellow",fg="black").place(x=20, y=400)
Button(window,text="DOWNLOAD",font=("Arial",25,"bold"),bg="lightblue",command=video_download).place(x=180,y=250)
